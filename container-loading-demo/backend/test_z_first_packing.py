"""
Test Z-First Packing Algorithm
"""
...
def test_z_first_packing():
    ...
    # Initialize packer
    packer = ZFirstPackingAlgorithm(container_dims=container_dims)
    
    # Pack boxes
    print("\n" + "="*80)
    print("Z-FIRST PACKING ALGORITHM")
    print("="*80)
    ...
    # Save to JSON file
    output_file = 'z_first_packing_result.json'
